...
const AccessType CLIENT_ACCESS_INVISIBLE	= 0x4;		// +i	| invisible par WHO
...
const AccessType CLIENT_ACCESS_BOT			= 0x80;		// +B	| indique que l'utilisateur est un bot
const AccessType CLIENT_ACCESS_OPERATOR		= 0x100;	// +oO	| serveur operator
const AccessType CLIENT_ACCESS_ADMIN		= 0x200;	// +aA	| server admin
